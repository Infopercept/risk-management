...
<body>
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span3">
                <?php view_reporting_menu("ClosedRisksByDate"); ?>
            </div>
            <div class="span9">
                <div class="row-fluid"><p><?php echo $escaper->escapeHtml($lang['ReportClosedByDateHelp']); ?>.</p></div>
                <?php get_closed_risks_table(); ?>
            </div>
        </div>
    </div>
</body>
