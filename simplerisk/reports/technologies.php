...
<body>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="span3">
        <?php view_reporting_menu("AllOpenRisksByTechnology"); ?>
      </div>
      <div class="span9">
        <div class="row-fluid"><p><?php echo $escaper->escapeHtml($lang['ReportRiskTechnologiesHelp']); ?>.</p></div>
        <?php get_risk_technologies_table(); ?>
      </div>
    </div>
  </div>
</body>
