...
?>
  ...
  <script src="../js/select2.min.js?<?php echo current_version("app"); ?>"></script>
  ...
  <link rel="stylesheet" href="../css/select2.min.css?<?php echo current_version("app"); ?>">
  <?php
    setup_favicon("..");
...
<body>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="span3">
        <?php view_reporting_menu("ConnectivityVisualizer"); ?>
      </div>
      <div class="span9">
        <div class="row-fluid">
          <?php get_connectivity_graph(); ?>
        </div>
      </div>
    </div>
  </div>
