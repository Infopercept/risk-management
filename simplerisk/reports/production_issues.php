...
<body>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="span3">
        <?php view_reporting_menu("AllOpenRisksToSubmitAsAProductionIssueByRiskLevel"); ?>
      </div>
      <div class="span9">
        <div class="row-fluid"><p><?php echo $escaper->escapeHtml($lang['ReportProductionIssuesHelp']); ?>.</p></div>
        <?php get_risk_table(7); ?>
      </div>
    </div>
  </div>
</body>
